         ...
         public static Monster HalfRedDragonVeteran {
            get {
                Monster halfRedDragonVeteran = new Monster(
                    ...
                    new Attack[] { Attacks.HalfRedDragonVeteranLongsword, Attacks.HalfRedDragonVeteranShortsword }, new Attack[] {  }, Size.MEDIUM
                );
         ...
         public static Monster HillGiant {
            get {
                Monster hillGiant = new Monster(
                    ...
                    new Attack[] { Attacks.HillGiantGreatclub }, new Attack[] {  }, Size.HUGE
                );
         ...
         public static Monster Hobgoblin {
            get {
                Monster hobgoblin = new Monster(
                    ...
                    new Attack[] { Attacks.HobgoblinLongsword }, new Attack[] {  }, Size.MEDIUM
                );
         ...
         public static Monster HornedDevil {
            get {
                Monster hornedDevil = new Monster(
                    ...
                    new Attack[] { Attacks.HornedDevilFork, Attacks.HornedDevilTail }, new Attack[] {  }, Size.LARGE
                );
