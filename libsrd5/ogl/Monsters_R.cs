...
namespace srd5 {
    public partial struct Attacks {
        ...
        public static Attack RakshasaClaw {
            get {
                return new Attack("Claw", 7, new Damage(SLASHING, "2d6+2"), 5, null, RakshasaClawEffect);
            }
        }
        public static Attack RatBite {
            get {
                return new Attack("Bite", 0, new Damage(PIERCING, "1d1"), 5);
            }
        }
        public static Attack RavenBeak {
            get {
                return new Attack("Beak", 4, new Damage(PIERCING, "1d1"), 5);
            }
        }
        public static Attack RedDragonWyrmlingBite {
            get {
                return new Attack("Bite", 6, new Damage(PIERCING, "1d10+4"), 5, new Damage(FIRE, "1d6"));
            }
        }
        ...
        public static Attack RemorhazBite {
            get {
                return new Attack("Bite", 11, new Damage(PIERCING, "6d10+7"), 5, new Damage(FIRE, "3d6"), RemorhazBiteEffect);
            }
        }
        public static Attack RhinocerosGore {
            get {
                return new Attack("Gore", 7, new Damage(BLUDGEONING, "2d8+5"), 5);
            }
        }
        ...
        public static Attack RocTalons {
            get {
                return new Attack("Talons", 13, new Damage(SLASHING, "4d6+9"), 5, null, RocTalonsEffect);
            }
        }
        public static Attack RocBeak {
            get {
                return new Attack("Beak", 13, new Damage(PIERCING, "4d8+9"), 10);
            }
        }
        ...
        public static Attack RoperTendril {
            get {
                return new Attack("Tendril", 7, new Damage(BLUDGEONING, 0), 5, null, RoperTendrilEffect);
            }
        }
        public static Attack RoperBite {
            get {
                return new Attack("Bite", 7, new Damage(PIERCING, "4d8+4"), 5);
            }
        }
        // !!!!!!!!!!!!!!!!!!!!!!UNPARSABLE ATTACK!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        public static Attack RugOfSmotheringSmother {
            get {
                return new Attack("Smother", 5, new Damage(SLASHING, 0), 5, null, RugOfSmotheringSmotherEffect);
            }
        }
        public static Attack RustMonsterBite {
            get {
                return new Attack("Bite", 3, new Damage(PIERCING, "1d8+1"), 5);
            }
        }
    }
    ...
    public partial struct Monsters {
        ...
        public static Monster Rakshasa {
            get {
                ...
                rakshasa.AddEffect(VULNERABILITY_PIERCING); // TODO: Only from Magic Weapons wielded by good creatures
                rakshasa.AddEffect(IMMUNITY_NONMAGIC);
        ...
        public static Monster RedDragonWyrmling {
            get {
                ...
                redDragonWyrmling.AddEffect(IMMUNITY_FIRE);
        ...
        public static Monster Remorhaz {
            get {
                ...
                remorhaz.AddEffect(IMMUNITY_COLD);
                remorhaz.AddEffect(IMMUNITY_FIRE);
        ...
        public static Monster RugOfSmothering {
            get {
                ...
                rugOfSmothering.AddEffect(IMMUNITY_POISON);
                rugOfSmothering.AddEffect(IMMUNITY_PSYCHIC);
                rugOfSmothering.AddEffect(IMMUNITY_BLINDED);
                rugOfSmothering.AddEffect(IMMUNITY_CHARMED);
                rugOfSmothering.AddEffect(IMMUNITY_BLINDED);
                rugOfSmothering.AddEffect(IMMUNITY_FRIGHTENED);
                rugOfSmothering.AddEffect(IMMUNITY_PARALYZED);
                rugOfSmothering.AddEffect(IMMUNITY_PETRIFIED);
                rugOfSmothering.AddEffect(IMMUNITY_POISONED);
