...
namespace srd5 {
    public partial struct Spells {
        public static Spell Alarm {
            get {
                return new Spell(ID.ALARM, SpellSchool.ABJURATION, SpellLevel.FIRST, CastingTime.ONE_MINUTE, 30, VSM, SpellDuration.EIGHT_HOURS, 20, 0, SpellWithoutEffect(ID.ALARM));
            }
        }

        public static Spell AnimalFriendship {
            get {
                return new Spell(ID.ANIMAL_FRIENDSHIP, SpellSchool.ENCHANTMENT, SpellLevel.FIRST, CastingTime.ONE_ACTION, 30, VSM, SpellDuration.ONE_DAY, 0, 1, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell Bane {
            get {
                return new Spell(ID.BANE, SpellSchool.ENCHANTMENT, SpellLevel.FIRST, CastingTime.ONE_ACTION, 30, VSM, SpellDuration.ONE_MINUTE, 0, 3, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell BurningHands {
            get {
                return new Spell(ID.BURNING_HANDS, SpellSchool.EVOCATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VS, SpellDuration.INSTANTANEOUS, 15, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell ColorSpray {
            get {
                return new Spell(ID.COLOR_SPRAY, SpellSchool.ILLUSION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VSM, SpellDuration.ONE_ROUND, 15, 10, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell Command {
            get {
                return new Spell(ID.COMMAND, SpellSchool.ENCHANTMENT, SpellLevel.FIRST, CastingTime.ONE_ACTION, 60, V, SpellDuration.ONE_ROUND, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell ComprehendLanguages {
            get {
                return new Spell(ID.COMPREHEND_LANGUAGES, SpellSchool.DIVINATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VSM, SpellDuration.ONE_HOUR, 0, 0, SpellWithoutEffect(ID.COMPREHEND_LANGUAGES));
            }
        }
        ...
        public static Spell DetectEvilandGood {
            get {
                return new Spell(
                    ID.DETECT_EVIL_AND_GOOD, SpellSchool.DIVINATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VS, SpellDuration.TEN_MINUTES, 30, 0, SpellWithoutEffect(ID.DETECT_EVIL_AND_GOOD)
                );
            }
        }
        ...
        public static Spell DisguiseSelf {
            get {
                return new Spell(ID.DISGUISE_SELF, SpellSchool.ILLUSION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VS, SpellDuration.ONE_HOUR, 0, 0, SpellWithoutEffect(ID.DISGUISE_SELF));
            }
        }
        ...
        public static Spell ExpeditiousRetreat {
            get {
                return new Spell(ID.EXPEDITIOUS_RETREAT, SpellSchool.TRANSMUTATION, SpellLevel.FIRST, CastingTime.BONUS_ACTION, 0, VS, SpellDuration.TEN_MINUTES, 0, 0, doNothing);
            }
        }
        ...
        public static Spell FalseLife {
            get {
                return new Spell(ID.FALSE_LIFE, SpellSchool.NECROMANCY, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VSM, SpellDuration.ONE_HOUR, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell FindFamiliar {
            get {
                return new Spell(ID.FIND_FAMILIAR, SpellSchool.CONJURATION, SpellLevel.FIRST, CastingTime.ONE_HOUR, 10, VSM, SpellDuration.INSTANTANEOUS, 0, 0, SpellWithoutEffect(ID.FIND_FAMILIAR));
            }
        }

        public static Spell FloatingDisk {
            get {
                return new Spell(ID.FLOATING_DISK, SpellSchool.CONJURATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 30, VSM, SpellDuration.ONE_HOUR, 0, 0, SpellWithoutEffect(ID.FLOATING_DISK));
            }
        }
        ...
        public static Spell Goodberry {
            get {
                return new Spell(ID.GOODBERRY, SpellSchool.TRANSMUTATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VSM, SpellDuration.INSTANTANEOUS, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell Grease {
            get {
                return new Spell(ID.GREASE, SpellSchool.CONJURATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 60, VSM, SpellDuration.ONE_MINUTE, 10, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
                    foreach (Combattant target in targets) {
        ...
        public static Spell GuidingBolt {
            get {
                return new Spell(ID.GUIDING_BOLT, SpellSchool.EVOCATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 120, VS, SpellDuration.ONE_ROUND, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
                    Combattant target = targets[0];
                    Dice dice = DiceSlotScaling(SpellLevel.FIRST, slot, D6, 3);
        ...
        public static Spell HellishRebuke {
            get {
                return new Spell(ID.HELLISH_REBUKE, SpellSchool.EVOCATION, SpellLevel.FIRST, CastingTime.REACTION, 60, VS, SpellDuration.INSTANTANEOUS, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell Heroism {
            get {
                return new Spell(ID.HEROISM, SpellSchool.ENCHANTMENT, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VS, SpellDuration.ONE_MINUTE, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
                    Combattant target = targets[0];
        ...
        public static Spell HideousLaughter {
            get {
                return new Spell(ID.HIDEOUS_LAUGHTER, SpellSchool.ENCHANTMENT, SpellLevel.FIRST, CastingTime.ONE_ACTION, 30, VSM, SpellDuration.ONE_MINUTE, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
                    Combattant target = targets[0];
        ...
        public static Spell HuntersMark {
            get {
                return new Spell(ID.HUNTERS_MARK, SpellSchool.DIVINATION, SpellLevel.FIRST, CastingTime.BONUS_ACTION, 90, V, SpellDuration.ONE_HOUR, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
                    Combattant target = targets[0];
                    target.AddDamageTakenEvent(delegate (object source, Damage damage) {
        ...
        public static Spell Identify {
            get {
                return new Spell(ID.IDENTIFY, SpellSchool.DIVINATION, SpellLevel.FIRST, CastingTime.ONE_MINUTE, 0, VSM, SpellDuration.INSTANTANEOUS, 0, 0, SpellWithoutEffect(ID.IDENTIFY));
            }
        }

        public static Spell IllusoryScript {
            get {
                return new Spell(ID.ILLUSORY_SCRIPT, SpellSchool.ILLUSION, SpellLevel.FIRST, CastingTime.ONE_MINUTE, 0, SM, SpellDuration.TEN_DAYS, 0, 0, SpellWithoutEffect(ID.ILLUSORY_SCRIPT));
            }
        }

        public static Spell InflictWounds {
            get {
                return new Spell(ID.INFLICT_WOUNDS, SpellSchool.NECROMANCY, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VS, SpellDuration.INSTANTANEOUS, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
                    Combattant target = targets[0];
                    Dice dice = DiceSlotScaling(SpellLevel.FIRST, slot, D10, 2);
        ...
        public static Spell MageArmor {
            get {
                return new Spell(ID.MAGE_ARMOR, SpellSchool.ABJURATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VSM, SpellDuration.EIGHT_HOURS, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
                    Combattant target = targets[0];
        ...
        public static Spell ProtectionfromEvilandGood {
            get {
                return new Spell(ID.PROTECTION_FROM_EVIL_AND_GOOD, SpellSchool.ABJURATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 0, VSM, SpellDuration.TEN_MINUTES, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell Sanctuary {
            get {
                return new Spell(ID.SANCTUARY, SpellSchool.ABJURATION, SpellLevel.FIRST, CastingTime.BONUS_ACTION, 30, VSM, SpellDuration.ONE_MINUTE, 0, 0, SpellWithoutEffect(ID.SANCTUARY));
            }
        }

        public static Spell Shield {
            get {
                return new Spell(ID.SHIELD, SpellSchool.ABJURATION, SpellLevel.FIRST, CastingTime.REACTION, 0, VS, SpellDuration.ONE_ROUND, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
        ...
        public static Spell ShieldofFaith {
            get {
                return new Spell(ID.SHIELD_OF_FAITH, SpellSchool.ABJURATION, SpellLevel.FIRST, CastingTime.BONUS_ACTION, 60, VSM, SpellDuration.TEN_MINUTES, 0, 0, delegate (Battleground ground, Combattant caster, int dc, SpellLevel slot, int modifier, Combattant[] targets) {
                    Combattant target = targets[0];
        ...
        public static Spell SilentImage {
            get {
                return new Spell(ID.SILENT_IMAGE, SpellSchool.ILLUSION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 60, VSM, SpellDuration.TEN_MINUTES, 15, 0, SpellWithoutEffect(ID.SILENT_IMAGE));
            }
        }

        public static Spell Sleep {
            get {
                return new Spell(ID.SLEEP, SpellSchool.ENCHANTMENT, SpellLevel.FIRST, CastingTime.ONE_ACTION, 90, VSM, SpellDuration.ONE_MINUTE, 20, 99,
        ...
        public static Spell UnseenServant {
            get {
                return new Spell(ID.UNSEEN_SERVANT, SpellSchool.CONJURATION, SpellLevel.FIRST, CastingTime.ONE_ACTION, 60, VSM, SpellDuration.ONE_HOUR, 0, 0, SpellWithoutEffect(ID.UNSEEN_SERVANT));
            }
        }
    }
}